		...
		<el-dialog title="编辑员工" v-model="isShowDialog" width="769px">
			<el-form :model="ruleForm" size="small" label-width="80px" :rules="rules" ref="myRefForm">
				<el-row :gutter="35">
					...
					<el-col class="mb20">
						<el-form-item label="分配部门" prop="deptList">
					...
					<el-col class="mb20">
						<el-form-item label="分配角色" prop="roleList">
	...
	setup(props, ctx) {
		...
		const state = reactive({
			...
			rules: {
				...
				"roleList": { required: true, message: '分配角色', trigger: 'blur' },
				"deptList": { required: true, message: '分配部门', trigger: 'blur' },
			},
		});
		// 打开弹窗
