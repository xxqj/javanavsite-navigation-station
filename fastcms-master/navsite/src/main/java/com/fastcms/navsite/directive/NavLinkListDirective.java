 ...
 *
 * <@navLinkListTag categoryId=category.id! includeCategoryIds="1,2,3" excludeCategoryIds="4,5,6" orderBy="created">
 *   <#if data??>
 ...
 * </@navLinkListTag>
 *
 * <@navLinkListTag tagId=tag.id! includeTagIds="1,2,3" excludeTagIds="4,5,6" orderBy="created">
 *     show data ...
 * </@navLinkListTag>
 *
 ...
 * @version: 1.0
 */
@Component("navLinkListTag")
public class NavLinkListDirective extends BaseDirective {
	...
	public Object doExecute(Environment env, Map params) {
		...
		String orderBy = getStr(PARAM_ORDER_BY, params, "a.sort_num");
		if(hasKey(ARTICLE_CATEGORY_ID, params) || hasKey(INCLUDE_CATEGORY_ID, params) || hasKey(EXCLUDE_CATEGORY_ID, params)) {
			return navLinkService.getLinksListByCategoryId(categoryId, includeCategoryIdList, excludeCategoryIdList, count, orderBy);
		}
		...
		if (hasKey(ARTICLE_TAG_ID, params) || hasKey(INCLUDE_TAG_ID, params) || hasKey(EXCLUDE_CATEGORY_ID, params)) {
			return navLinkService.getLinksListByCategoryId(tagId, includeTagIdList, excludeTagIdList, count, orderBy);
		}

		return navLinkService.getLinksListByCategoryId(null, null, null, count, orderBy);
	}
