...
public abstract class AbstractCodeGen {
    ...
    final static String url = "jdbc:mysql://localhost:3306/danganguanli?autoReconnect=true&useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai";
    final static String username = "root";
    final static String password = "Gf123@";
    ...
    protected void gen() {
        FastAutoGenerator.create(url, username, password)
                .globalConfig(builder -> {
                    builder.author("879081656@qq.com") // 设置作者
                            .disableOpenDir()
