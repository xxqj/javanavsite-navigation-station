...
public interface IDepartmentService extends IService<Department> {
	...
	class DepartmentNode extends TreeNode {
		...
		public DepartmentNode(Long id, Long cmpyId,Long parentId, String deptName, String deptDesc, Integer status, String deptLeader, Integer sortNum, String deptPhone, LocalDateTime created) {
