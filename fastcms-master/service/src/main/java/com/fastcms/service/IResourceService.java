...
public interface IResourceService extends IService<Resource> {
	...
	interface ResourceI18n {
		...
		String RESOURCE_NAME_CONFIG_EDIT = "fastcms.resource.name.config.edit";
		String RESOURCE_NAME_CONFIG_REFRESH = "fastcms.resource.name.config.refresh";
		String RESOURCE_NAME_CONFIG_SAVE = "fastcms.resource.name.config.save";
		String RESOURCE_NAME_CONFIG_DELETE = "fastcms.resource.name.config.delete";
		String RESOURCE_NAME_CONFIG_LIST = "fastcms.resource.name.config.list";
		String RESOURCE_NAME_CONFIG_PLIST = "fastcms.resource.name.config.plist";
        ...
        //公司接口资源
		String RESOURCE_NAME_CMPY_LIST = "fastcms.resource.name.cmpy.list";
		String RESOURCE_NAME_CMPY_PLIST = "fastcms.resource.name.cmpy.plist";
		String RESOURCE_NAME_CMPY_SAVE = "fastcms.resource.name.cmpy.save";
		String RESOURCE_NAME_CMPY_DETAIL = "fastcms.resource.name.cmpy.detail";
		String RESOURCE_NAME_CMPY_DELETE = "fastcms.resource.name.cmpy.delete";

        //产品类目接口资源
		String RESOURCE_NAME_CATEGORY_LIST = "fastcms.resource.name.category.list";
		String RESOURCE_NAME_CATEGORY_PLIST = "fastcms.resource.name.category.plist";
		String RESOURCE_NAME_CATEGORY_SAVE = "fastcms.resource.name.category.save";
		String RESOURCE_NAME_CATEGORY_DETAIL = "fastcms.resource.name.category.detail";
		String RESOURCE_NAME_CATEGORY_DELETE = "fastcms.resource.name.category.delete";

		//产品类目接口资源
		String RESOURCE_NAME_PRODUCT_LIST = "fastcms.resource.name.product.list";
		String RESOURCE_NAME_PRODUCT_PLIST = "fastcms.resource.name.product.plist";
		String RESOURCE_NAME_PRODUCT_SAVE = "fastcms.resource.name.product.save";
		String RESOURCE_NAME_PRODUCT_DETAIL = "fastcms.resource.name.product.detail";
		String RESOURCE_NAME_PRODUCT_DELETE = "fastcms.resource.name.product.delete";


		String RESOURCE_NAME_NAVMENU_LIST = "fastcms.resource.name.navmenu.list";
		String RESOURCE_NAME_NAVMENU_SAVE = "fastcms.resource.name.navmenu.save";
		String RESOURCE_NAME_NAVMENU_DELETE = "fastcms.resource.name.navmenu.delete";


		String RESOURCE_NAME_NAVLINK_LIST = "fastcms.resource.name.navlink.list";
		String RESOURCE_NAME_NAVLINK_CLIST = "fastcms.resource.name.navlink.clist";
		String RESOURCE_NAME_NAVLINK_PLIST = "fastcms.resource.name.navlink.plist";
		String RESOURCE_NAME_NAVLINK_SAVE = "fastcms.resource.name.navlink.save";
		String RESOURCE_NAME_NAVLINK_DELETE = "fastcms.resource.name.navlink.delete";
